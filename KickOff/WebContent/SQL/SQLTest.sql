...
insert into articlegroup values (22,'진행용품','라인기');
insert into articlegroup values (23,'진행용품','경고카드');
insert into articlegroup values (24,'진행용품','주장완장');
insert into articlegroup values (25,'진행용품','호각');
