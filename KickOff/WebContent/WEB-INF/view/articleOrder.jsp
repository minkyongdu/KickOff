...
<script type="text/javascript">
   $(document).ready(function() {
      $("#order").click(function() {
         ...
         if (Number(count) < Number(amount)) { //재고 수량보다 선택한 수량이 클때
            alert("재고보다 선택한 갯수가 많습니다.");
            return false;
         } else {
            $("#orderinsert").submit();
         }
...
<body onload="init();">
   ...
   <form name="articleOrderForm" method="post" action="articleOrder">
         ...
         <tbody>
            <tr>
               <td height="60" align="center" style="width: 150px;"><img
                  src="/KickOff/img/${article.imgFile1}" width="100" height="100">
               </td>

               <td align="center">${article.aname}</td>
               <td align="center"><c:if test="${Asize != null}">
                                 ${Asize}
                              </c:if></td>
               <td align="center" rowspan="1"><input type="text"
                  name="buyamount" value="${amount}" size="1" onchange="change();">
                  개 <input type="button" value=" + " onclick="add();"><input
                  type="button" value=" - " onclick="del();"><br></td>
               <td align="center"><fmt:formatNumber value="${article.price}"
                        ...
                        <tr>
                           ...
                           <td align="right">
                              <p id="paper_goodsprice"
                                 style="width: 146px; text-align: right; font-weight: bold; float: left; margin: 0">
                                 <input type="text" name="price" size="5" readonly="readonly"
                                    align="top">
                              </p>원
                           </td>
                        </tr>
      ...
      <div style="padding: 20px" align="center">
         ...
         <a href="/KickOff/articleDetail?articleNum=${article.articleNum}">
