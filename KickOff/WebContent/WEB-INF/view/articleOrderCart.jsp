...
<c:forEach var="list" items="${list}" varStatus="status">
	...
	<input type="hidden" name="Asize" value="${list.asize}">
		...
		총 금액 : <input type="hidden" size="11"name="price" readonly value="${list.amount*list.price}">원
		</c:forEach>
		</table>
		<table border=1>
			<tr>
...
<%-- 	<input type="text" name="Asize" value="${list.asize}">
	<input type="text" name="Aname" value="${list.aname}"> --%>
