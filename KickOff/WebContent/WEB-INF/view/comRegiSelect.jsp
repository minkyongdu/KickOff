	...
	<div class="contents">
		<img src="img/companyonly.png">
          ...
          <map name="Map">
            ...
            <area shape="poly" coords="300,302,50,402,76,452,103,484,137,515,185,544,237,561,294,568,380,556,431,534,476,502,522,451,538,417,549,395" href="comOrderList?companyNum=${sessionScope.comLoginInfo.companyNum}&pageNumber=1">
          </map>
	</div>
</center>	
</div>  
