...
function Radiocheck(){
	if($(':radio[name="chkConfirm"]:checked').val() == "N" 
		...
		document.comregterm.action = "comRegister";
...
<div class="wrap">
  <div class="header" align="center">
	...
	<form name = "comregterm" method = "post" action = "javascript:Radiocheck();">
		<tr>
		<img src="img/comregister.png">
                           <td></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                        ...
                        <tr bgcolor="#FFFFFF">
                           <td colspan="5" class="usual_black"><font face="Webdings">4</font>서비스이용
                              약관</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
