	...
	<!-- 이벤트 글 입력 유효성 검사 -->
	   $(document).ready(function (){
	      $('#insert').click(function() {
	         if($('#title').val()==""&&$('#contents').val()==""&&$('#writer').val()==""){
...
<form method="post" id="eventinsert" action="eventinsert" name="eventinsert" enctype="multipart/form-data">
	  <c:choose>
	  <c:when test="${sessionScope.userLoginInfo.memGrade != 6}">
         <script type="text/javascript">
         location.href='loginForm';
  ...
  <tr>
    <td width="120" align = "center" colspan="2"><font size="5"><b>이벤트 작성</b></font></td>
  </tr>
  <center> 
  <tr></tr><tr></tr>
  <table> 
  ...
  <tr>
    ...
    <td valign="middle"><textarea id = "contents" name = "contents" style="width: 700px; height: 200px;"></textarea></td>
  </tr>
  <tr>
