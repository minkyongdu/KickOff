	    ...
	    <br>
					...
					<center>
   						...
   						<c:forEach var="notice" items="${NoticeList}">
							<tr> 
								<td width=50 height="20" align=center><img src = "img/noticeBtn.png" width="40" height="25"></td>
								<td align=center style="padding-left:10px; width: 466px">
								<a href="noticeDetail?noticeno=${notice.noticeno}&pageNumber=1"><b>${notice.title}</b></a></td>
								<td width=100 nowrap align=center class=eng style="width: 123px; "><b>운영자</b></td>
								<td width=70 nowrap align=center class=eng style="width: 100px; "><b>${notice.noticeDate.split(" ")[0]}</b></td>
								<td width=30 nowrap align=center class=eng style="width: 50px; "><b>${notice.hit}</b></td>
							</tr>
						</c:forEach>
						</table>
						<center>
							<c:if test="${sessionScope.userLoginInfo.memGrade == 6}">
										<a href="noticeWriteForm"><img src = "img/writebtn.png"></a>
							</c:if>
						</center>
					<br>
					<center>  
					...
					<input type = "hidden" id = "writeNum" value = "${notice.noticeno}">
							<table width="600">
								<tr>
									<td colspan="5" align="center"><c:if test="${startPage>1}">
											<span> <a
												href="/KickOff/noticeListForm?pageNumber=${startPage-1}">이전</a>
											</span>
										</c:if> <c:forEach var="i" begin="${startPage}" end="${endPage}">
											<c:choose>
												<c:when test="${pageNumber == i }">
													<span> <a
														href="/KickOff/noticeListForm?pageNumber=${i}"
											...
											<span> <a
												href="/KickOff/noticeListForm?pageNumber=${endPage+1}">다음</a>
											</span>
										</c:if></td>
									</tr>
								</tr>
