...
<map name="Map">
	...
	<form id= "noticeupdate" action="noticeUpdate" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="noticeno" value="${NoticeUpdate.noticeno}">
	    <center>
    <table cellpadding="4">
       <tr> 
         <th width = "200" align = "center">제목</th><td>  
         <input type = "text" id = "title" name = "title" size="114" value = "${NoticeUpdate.title}">
         </td>
       </tr>
       <tr>
         <th width = "200" align ="center">작성자</th><td>${NoticeUpdate.writer}</td>
       </tr>
       <tr> 
        	...
        	<td>
				...
				<c:when test="${NoticeUpdate.fileName != null}">
					  <img id="img1" src="/KickOff/img/${NoticeUpdate.fileName}" width="95%"><br>
					<input type="hidden" value="${NoticeUpdate.fileName}" name="fileName">
				</c:when>
			</c:choose>
			<c:choose>
				<c:when test="${NoticeUpdate.fileName == null}">
         	...
         	<c:choose>	
				<c:when test="${NoticeUpdate.fileName2 != null}">
					<img id="img2" src="/KickOff/img/${NoticeUpdate.fileName2}" width = "95%"><br>
					<input type="hidden" value="${NoticeUpdate.fileName2}" name="fileName2">
				</c:when>
			</c:choose>
			<c:choose>
				<c:when test="${NoticeUpdate.fileName2 == null}">
         	...
         	<c:choose>		
				<c:when test="${NoticeUpdate.fileName3 != null}">
					<img id="img3" src="/KickOff/img/${NoticeUpdate.fileName3}" width = "95%"><br>		
					<input type="hidden" value="${NoticeUpdate.fileName3}" name="fileName3">	
				</c:when>
			</c:choose>
			<c:choose>
				<c:when test="${NoticeUpdate.fileName3 == null}">
			...
			<textarea rows="7" cols="85" id="contents" name = "contents" >${NoticeUpdate.contents}</textarea>
      ...
      <input type = "image" src = "img/golistbtn.png" onclick="location.href='noticeListForm'">
      <!-- <input type="button" value="수정" id="update">
      <input type="button" value="목록" onclick="location.href = 'noticeListForm'"> -->
	
	<input type="hidden" id = "writer" name="writer" value="${NoticeUpdate.writer}">
  </center>
</form>
 <center>
